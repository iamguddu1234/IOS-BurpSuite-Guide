            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text2(title1: gg1, title2: gg2)
                        
                        Text5(title1: gg3, title2: gg4, title3: gg5, title4: gg6, title5: gg7)
                        
                        Text5(title1: gg8, title2: gg9, title3: gg10, title4: gg11, title5: gg12)
                        
                        Text5(title1: gg13, title2: gg14, title3: gg15, title4: gg16, title5: gg17)
                        
                        Text5(title1: gg18, title2: gg19, title3: gg20, title4: gg21, title5: gg22)
                        
                        Text5(title1: gg23, title2: gg24, title3: gg25, title4: gg26, title5: gg27)
                        
                        Text5(title1: gg28, title2: gg29, title3: gg30, title4: gg31, title5: gg32)
                        
                        Text5(title1: gg33, title2: gg34, title3: gg35, title4: gg36, title5: gg37)
                        
                        Text5(title1: gg38, title2: gg39, title3: gg40, title4: gg41, title5: gg42)
                        
                        Text5(title1: gg43, title2: gg44, title3: gg45, title4: gg46, title5: gg47)
                        
                        Text5(title1: gg48, title2: gg49, title3: gg50, title4: gg51, title5: gg52)
                        
                        Text2(title1: gg53, title2: gg54)
