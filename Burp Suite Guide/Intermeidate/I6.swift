            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text2(title1: u1, title2: u2)
                        
                        Text3(title1: u3, title2: u4, title3: u5)
                        
                        Head(title: u6)
                        
                        Text2(title1: u7, title2: u8)
                        
                        Text3(title1: u9, title2: u10, title3: u11)
                        
                        Text2(title1: u12, title2: u13)
                        
                        Head(title: u14)
                        
                        Text2(title1: u15, title2: u16)
                        
                        Text6(title1: u17, title2: u18, title3: u19, title4: u20, title5: u21, title6: u22)
                        
                        Head(title: u23)
                        
                        
                        Text3(title1: u24, title2: u25, title3: u26)
                        
                        Text2(title1: u27, title2: u28)
                        
                        Text3(title1: u29, title2: u30, title3: u31)
                        
                        Text2(title1: u32, title2: u33)
                        
                        Head(title: u34)
                        
                        Text3(title1: u35, title2: u36, title3: u37)
                        
                        Text5(title1: u38, title2: u39, title3: u40, title4: u41, title5: u42)
                        
                        Text6(title1: u43, title2: u44, title3: u45, title4: u46, title5: u47, title6: u48)
                        
                        Text4(title1: u49, title2: u50, title3: u51, title4: u52)
                        
                        Text2(title1: u53, title2: u54)
                        
                        Head(title: u55)
                        
                        Text2(title1: u56, title2: u57)
                        
                        Text4(title1: u58, title2: u59, title3: u60, title4: u61)
                        
                        Text3(title1: u62, title2: u63, title3: u64)
                        
                        Text4(title1: u65, title2: u66, title3: u67, title4: u68)
                        
                        Text2(title1: u69, title2: u70)
