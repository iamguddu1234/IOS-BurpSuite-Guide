            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text2(title1: q1, title2: q2)
                        
                        Head(title: q3)
                        
                        Text5(title1: q4, title2: q5, title3: q6, title4: q7, title5: q8)
                        
                        Text2(title1: q9, title2: q10)
                        
                        Text4(title1: q11, title2: q12, title3: q13, title4: q14)
                        
                        Text3(title1: q15, title2: q16, title3: q17)
                        
                        Text2(title1: q18, title2: q19)
                        
                        Text3(title1: q20, title2: q21, title3: q22)
                        
                        Text4(title1: q23, title2: q24, title3: q25, title4: q26)
                        
                        Text4(title1: q27, title2: q28, title3: q29, title4: q30)
                        
                        Text6(title1: q31, title2: q32, title3: q33, title4: q34, title5: q35, title6: q36)
                        
                        Head(title: q37)
                        
                        Text3(title1: q38, title2: q39, title3: q40)
                        
                        Text3(title1: q41, title2: q42, title3: q43)
                        
                        Text2(title1: q44, title2: q45)
                        
                        Text3(title1: q46, title2: q47, title3: q48)
                        
                        Text3(title1: q49, title2: q50, title3: q51)
